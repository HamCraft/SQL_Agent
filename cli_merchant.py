...
def classify_intent(llm: ChatGoogleGenerativeAI, query: str) -> str:
    ...
    messages = [
        ("system", "You are an assistant that classifies user queries into two categories ONLY:\n\n"
            "- sales_query: The user is asking about sales data, customer, items, report, revenue, orders, profits, sales formula, forecasting formula or anything related to sales reports or customer or items or forecasting of sales.\n"
